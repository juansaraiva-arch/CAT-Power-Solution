...
_ADF_TABLE = [
    ...
    [1, 1, 1, 1, 1, 1, 1, 0.98, 0.95, 0.92, 0.88, 0.85, 0.82],
    # 20°C  (corrected P11 — derate starts at 1750m per EM7206-05-001)
    [1, 1, 1, 1, 1, 1, 1, 0.97, 0.94, 0.90, 0.87, 0.84, 0.81],
    # 25°C
    ...
    # 40°C  (corrected P11 — derate starts at 1000m per EM7206-05-001)
    [1, 1, 1, 1, 0.96, 0.91, 0.86, 0.81, 0.76, 0.71, 0.67, 0.63, 0.59],
    # 45°C
